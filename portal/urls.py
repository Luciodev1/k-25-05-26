...
urlpatterns = [
    ...
    path('portal/conta/exportar/pdf/', views.PortalExportStatementPDFView.as_view(), name='export_statement_pdf'),
    path('portal/conta/partilhar/', views.PortalShareStatementView.as_view(), name='share_statement'),
    path('portal/partilhado/<token>/', views.PortalSharedStatementView.as_view(), name='shared_statement'),
