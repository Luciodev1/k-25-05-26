...
MIDDLEWARE = [
    ...
    'portal.middleware.PortalErrorRedirectMiddleware',
...
# Email configuration (use console backend for dev)
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', COMPANY_INFO['EMAIL'])
...
# Storage backends (S3-compatible via django-storages)
...
if not DEBUG:
    # Permite que Django detecte HTTPS quando atrás de proxy reverso (nginx, Cloudflare)
